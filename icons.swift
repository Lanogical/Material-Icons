...
//
//  Created by DeveloperBen on 1/21/17.
...
class icons{
    ...
    static let swip_forward = UIImage(named: "cm_skip_forward_white")?.withRenderingMode(.alwaysTemplate)
